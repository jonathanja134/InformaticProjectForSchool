...
async function main(){
    ...
    let wallet = new ethers.Wallet("0x11a651499e1ce3cfbeaee217b189381e1ff1006a53b1224277e70eb6fbfa2389", provider) // var creer pour représenter 
    // le wallet qui va payer les frais de gaz nécéssaire avec la clé privé utilisé et la var créer précédement
    const abi = fs.readFileSync("./pixicam_sol_pixicam.abi", "utf8") // associe l'abi de notre smart contract obtenu en le compilant 
    // dans la var constante abi
    const binary = fs.readFileSync(
        "./pixicam_sol_pixicam.bin",
        "utf8"
    )// idem pour file.bin
